  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Lab Planner - Streamlining Your Resource Management for Multiple Tasks. Experience Efficiency Like Never Before."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1518976024611-28bf4b48222e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxwbGFubmluZ3xlbnwwfHx8fDE2OTA2NDQyMDN8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Lab Planner - Streamlining Your Resource Management for Multiple Tasks. Experience Efficiency Like Never Before.`}
            </Text>
            <Box
            ...
            >
              <Stack direction="column" spacing={6}>
                ...
                <Card userTypeName="Client" type="client" />
              </Stack>
            </Box>
          </Box>
          <Box pt={4}>
